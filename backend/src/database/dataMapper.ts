...
//     const result = await sequelize.query("SELECT * FROM users WHERE email = $1", [email]);
...
//     await sequelize.query("DELETE FROM users WHERE id = $1", [id]);
//   },
//
//   async updateUser(
//     id: number,
...
//   //   await sequelize.query(`DELETE FROM flight_log_content WHERE id=$1 `, [id]);
//   // },
// };
